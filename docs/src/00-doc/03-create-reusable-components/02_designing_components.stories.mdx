...
- Make sure to define the **responsive** behaviour of the component and provide examples of its adaptation to different devices. 
...
A determining deciding factor in design decision-making can be user feedback >>>>> CONTINUE HERE
