...
You can access the existing components' source code in the [components folder](https://github.com/wmde/wikit/tree/master/vue-components/src) of the WiKit repository. Follow the standard component creation steps to proceed with your modification:
