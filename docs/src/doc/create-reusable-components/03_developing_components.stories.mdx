...
Once your changes are merged and you want to release a new version of the components library you need to take the following steps:
 - First create and push a new tag in compliance with [semantic versioning standards](https://semver.org/), e.g. `v1.2.3`. Alternatively you can use the npm provided tool [npm-version](https://docs.npmjs.com/cli/version)
