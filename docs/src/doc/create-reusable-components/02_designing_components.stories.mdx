...
**[1. Designing new system components](?path=/story/documentation-how-to-create-reusable-components-designing-components--page#1-designing-new-system-components)** <br/>
 [1.1. Discover](?path=/story/documentation-how-to-create-reusable-components-designing-components--page#11-discover)<br/>
 [1.2. Design](?path=/story/documentation-how-to-create-reusable-components-designing-components--page#12-design)<br/>
 [1.3. Decide](?path=/story/documentation-how-to-create-reusable-components-designing-components--page#13-decide)<br/>
 [1.4. Document](?path=/story/documentation-how-to-create-reusable-components-designing-components--page#14-document)<br/>
 [1.5. The design definition of done](?path=/story/documentation-how-to-create-reusable-components-designing-components--page#15-the-design-definition-of-done) <br/>

**[2. Using design tokens](?path=/story/documentation-how-to-create-reusable-components-designing-components--page#2-using-design-tokens)** <br/>
  [2.1. Introduction: Design tokens in the context of the Wikidata design system](?path=/story/documentation-how-to-create-reusable-components-designing-components--page#21-introduction-what-are-design-tokens-in-the-context-of-the-wikidata-design-system)<br/>
  [2.2. Using tokens to specify a new component](?path=/story/documentation-how-to-create-reusable-components-designing-components--page#22-using-tokens-to-specify-a-new-component)<br/>
  
**[3. Design handover](?path=/story/documentation-how-to-create-reusable-components-designing-components--page#3-design-handover)**<br/>
...
- **Interaction patterns** can be based on the existing components’ documentation templates ([See 1.4](?path=/story/documentation-how-to-create-reusable-components-designing-components--page#14-document)) and their displayed behavior at the Storybook stories. Existing patterns (the behavior of the current version of the component in production) will also be evaluated and applied to the new component version in case that doesn’t contradict the system ([See 1.1](?path=/story/documentation-how-to-create-reusable-components-designing-components--page#11-discover)).

If you still hesitate about the appropriateness of certain color or size after checking the visual guidelines and existing designs, you could find guidance in alias tokens. These tokens encapsulate the shared styling patterns of the system: their names express the intended use of any given visual value ([See 2](?path=/story/documentation-how-to-create-reusable-components-designing-components--page#2-using-design-tokens)). They can also help you make accessible design decisions.
...
- Outline **visual specifications** (sizes, paddings, typographic styles, colors) of both the default and all component states. It should be possible to translate all these specifications using design tokens during handover ([See 3](?path=/story/documentation-how-to-create-reusable-components-designing-components--page#3-design-handover)).
...
- The design of the component and **all its interactive states** are fully represented in Figma, and all the component’s essential documentation is defined ([See 1.4](?path=/story/documentation-how-to-create-reusable-components-designing-components--page#14-document))
...
- The totality of the component’s visual and interactive characteristics can be expressed using **design tokens** ([See 2](?path=/story/documentation-how-to-create-reusable-components-designing-components--page#2-using-design-tokens))

All the items on the previous list are a prerequisite to consider the component ready for handover ([See 3](?path=/story/documentation-how-to-create-reusable-components-designing-components--page#3-design-handover)).
...
- **Define the style of a component**: Since tokens capture the system’s styling patterns and premade decisions ([See 2.1](/?path=/story/documentation-how-to-create-reusable-components-designing-components--page#21-introduction-what-are-design-tokens-in-the-context-of-the-wikidata-design-system)), they can provide guidance to designers working to define the styles of new system components from scratch.

- **Create specs**: Once the design of the new component is ready, its styles will be outlined using design tokens ([See 2.2](?path=/story/documentation-how-to-create-reusable-components-designing-components--page#22-using-tokens-to-specify-a-new-component)). This is a necessary step of the handover process ([See 3](?path=/story/documentation-how-to-create-reusable-components-designing-components--page#3-design-handover)).
...
Designers should only use tokens (aliases or globals) rather than concrete values (e.g. pixels or hex colors) to define the handover specs of any newly designed system component. Developers will then use the provided alias or global tokens to define the low-level component-specific tokens applied to style components ([See 3](?path=/story/documentation-how-to-create-reusable-components-designing-components--page#3-design-handover)).
...
- Component specs that are fully outlined using tokens (as defined in 1.4):
  ...
  - **Visual** specification (sizes, paddings, typographic styles, colors) are fully defined using design tokens ([See 3](?path=/story/documentation-how-to-create-reusable-components-designing-components--page#3-design-handover)).
