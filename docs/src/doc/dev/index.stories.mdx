...
We are documenting our architecture decisions inside as Architecture Decision Records. Please find them in `adr/`.
...
The code of Wikit is organized into multiple packages, each tending to its on distinct task:
